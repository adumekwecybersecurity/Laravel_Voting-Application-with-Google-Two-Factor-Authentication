...
@section('staff')
    ...
    <!-- Main content -->
    <form method="post" action="{{route('staffpassword.store')}}" >
        @csrf
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><strong>STAFF-CREDENTIALS</strong></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <p class="text-muted">{{$staffdata->surName}}</p>
                <hr>

                <strong><i class="fas fa-user"></i> Middle-Name:</strong>
                <p class="text-muted">{{$staffdata->midName}}</p>
                <hr>

                <strong><i class="fas fa-user"></i>&nbsp;&nbsp;First-Name:</strong>
                <p class="text-muted">
                  <span class="tag tag-danger">{{$staffdata->firstName}}</span>
                </p>
               

                <p class="text-muted">
                  
                    <span class="tag tag-danger"><a href="{{route('staffpassword.store')}}"><button type="submit" class="btn btn-block btn-success"><strong>Update-Password</strong></button></a></span>
                  </p>
                  <hr>
