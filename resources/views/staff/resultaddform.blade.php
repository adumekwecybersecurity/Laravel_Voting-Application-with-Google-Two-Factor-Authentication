      ...
      <div class="row mb-2">
        <section class="content">
            <div class="container-fluid">
              ...
              <form method="post" action="{{route('staff.resultpost')}}" enctype="multipart/form-data">
                @csrf
      
                  <div class="card card-info">
                    <div class="card-header">
                      <h3 class="card-title"><strong>ADD THE WINNING CANDIDATE</strong></h3>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-4">
                          <br>
                          <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-envelope"></i></span><input type="text" class="form-control" placeholder="Total Votes" name="Total_Votes" required>
                          </div>
                        ...
                        <div class="col-5">
                          ...
                          <div class="col-5">
                            ...
                            <input type="text" class="form-control" placeholder="Position Won" name="position" required>
                          </div></div>
                          ...
                          <div style="color: red">Upload Winning/Candidate photo here***</div>
                          </div></div>


                          <br><br>
                          <div class="col-5">
                            <button type="reset" class="btn btn-danger"><strong>Cancel/Reset</strong></button>&nbsp;&nbsp;&nbsp; <button type="Submit" class="btn btn-primary"><strong>Add-Winners</strong></button>
                          </div>
